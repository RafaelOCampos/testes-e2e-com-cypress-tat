...
Cypress.Commands.add('guiLogin', (
  username = Cypress.env('USER_EMAIL'), //set default username and password
...
Cypress.Commands.add('createNote', (note, attachFile = false) => { //funçao por default false para não anexar arquivo
  cy.visit('/notes/new')
...
Cypress.Commands.add('fillSettingsFormAndSubmit', () => {
  ...
  cy.iframe('.card-field iframe') //iframe dentro do iframe
    .as('iframe') //alias para o iframe
